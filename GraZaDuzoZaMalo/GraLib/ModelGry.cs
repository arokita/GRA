...

{
...

    {
        ...
        public List<Ruch> Historia { get; private set; }     // tylko jeden element może być przechowywanym w liście 
...

        {
            ...
            if (propozycja < wylosowana)
            {
                ...
                //Historia.Add(r);                           // te dwie linijki kodu nr 65,66 sa prawie równoważne do 67
